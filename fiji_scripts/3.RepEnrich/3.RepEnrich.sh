...
input_folder=/Users/evle4518/projects/stress_granules/repetitive_elements/data/RepEnrich

output_folder=/Users/evle4518/projects/stress_granules/repetitive_elements/data/RepEnrich

setup_folder=/Users/evle4518/projects/stress_granules/repetitive_elements/scripts/3.RepEnrich/RepEnrich_setup_hg38


cd /Users/evle4518/projects/stress_granules/repetitive_elements/scripts/3.RepEnrich

python RepEnrich.py \
$data_folder/hg38_repeatmasker_clean.txt \
$output_folder/$file_name $file_name \
$setup_folder \
$input_folder/"$file_name"_multimap_1.fastq \
--fastqfile2 $input_folder/"$file_name"_multimap_2.fastq \
