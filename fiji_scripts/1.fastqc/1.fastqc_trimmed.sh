...
IN=/Users/evle4518/projects/quiescence/data/fastq/trimmed
OUT=/Users/evle4518/projects/quiescence/data/fastqc/trimmed

read_num=1
file_name=Min_"$num"_S"$num"_R"$read_num"_paired_trimmomatic
